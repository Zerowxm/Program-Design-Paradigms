...
(define WORLD-RACKET-WITH-3SPEED1
  (world-after-key-event
   (world-after-key-event
  ...
  (world-after-key-event
   (world-after-key-event
    (world-after-key-event
     (world-after-key-event
      (world-after-key-event
       (world-after-key-event WORLD-RACKET-WITH-3SPEED1 UP) UP) UP) UP) UP) UP))
...
(define WORLD-RACKET-WITH-6SPEED-63TICK
  (world-after-key-event
   (world-after-key-event
    (world-after-key-event (world-after-n-ticks WORLD-RACKET-WITH-3SPEED1 62) UP) UP) UP))
