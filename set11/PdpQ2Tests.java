...
public class PdpQ2Tests {
    ...
    static RosterWithStream roster(Player... ps) {
    ...
    public static void main(String[] args) {
        ...
        addCase(tests, "equals, same order, immutability", () -> {
            RosterWithStream r2 = roster(p6, p7, p8, p9, p10);
            RosterWithStream r3 = roster(p6, p7, p8, p9, p10);
            r3.with(p1); // no effect
            return r3.equals(r2);
        }, true);

        addCase(tests, "equals, different order", () -> {
            RosterWithStream r2 = roster(p9, p6, p8, p10, p7);
            RosterWithStream r3 = roster(p6, p7, p8, p9, p10);
            return r3.equals(r2);
        }, true);
        ...
        addCase(tests, "readyRoster equals partial roster", () -> {
            RosterWithStream r2 = roster(p6, p7, p9, p10);
            RosterWithStream r3 = r2.with(p8);
        ...
        addCase(tests, "readyRosters are equal", () -> {
            RosterWithStream r2 = roster(p6, p7, p9, p10, p8);
            RosterWithStream r3 = roster(p9, p10, p6, p7, p8, p8, p10);
            p8.changeContractStatus(false);
        ...
        addCase(tests, "hashCode, redundant addition", () -> {
            RosterWithStream r2 = roster(p6, p7, p8, p9, p10);
            RosterWithStream r3 = roster(p6, p7, p8, p9, p10, p6);
            return r3.hashCode() == r2.hashCode();
        }, true);

        addCase(tests, "hashCode, immutability", () -> {
            RosterWithStream r = roster(p1);
            int c = r.hashCode();
        ...
        addCase(tests, "toString(), one empty", () -> {
            RosterWithStream r2 = roster();
            RosterWithStream r3 = roster(p6, p7, p8, p9, p10, p5);
        ...
        addCase(tests, "set size, immutability", () -> {
            RosterWithStream r2 = roster(p6, p7, p8, p8, p7);
        ...
        addCase(tests, "without()", () -> {
            RosterWithStream r2 = roster(p6, p7, p8, p9, p10);
            RosterWithStream r3 = roster(p6, p7, p8, p8)
                    .without(p7).with(p7)
                    .without(p9).with(p9)
                    .with(p10)
                    .with(p5).without(p5);
        ...
        addCase(tests, "without, immutability", () -> {
            RosterWithStream r = roster(p7, p8);
        ...
        addCase(tests, "empty roster has nothing", () -> {
            return RosterWithStreams.empty().has(p1);
        }, false);

        addCase(tests, "iterator over one player", () -> {
            RosterWithStream r = roster(p5);
        ...
        addCase(tests, "iterator over multiple players", () -> {
            ...
            RosterWithStream r1 = roster(p11, p12, p13, p14, p15);
        ...
        addCase(tests, "iterator, immutability", () -> {
            RosterWithStream r = roster(p8, p5, p6);
